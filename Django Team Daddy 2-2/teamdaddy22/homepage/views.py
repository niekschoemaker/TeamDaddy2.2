...
def index(request):
	return render(request=request, template_name="homepage/login.html", context={"date": time.strftime("%H:%M:%S")})
...
def data(request):
	return render(request=request, template_name="homepage/home.html", context={})